...
function loadStatsPage()
{
	...
	{
		homeScore= parseInt(table.rows[row_count].cells[2].innerHTML);
		awayScore= parseInt(table.rows[row_count].cells[3].innerHTML);
		...
		if(homeScore > awayScore)
		{
			...
			winner= table.rows[row_count].cells[1].innerHTML;
			loss++;
		}
		table.rows[row_count].cells[4].innerHTML= winner;
		winner="";
	}
...
function loadPlayersPage()
{
	...
	for(var i=0; i<players.length; i++)
	{
		...
		el.href="#";
		el.setAttribute("onclick", "switchPlayers(" + i + ")");
		menu.appendChild(el);
	}
